...
class TestStockApi(unittest.TestCase):
    ...
    def test_get_stocks_close_price_with_given_date(self) -> None:
        return_value = {"2024-01-01": [MockPolygonStock("AAPL", 200)],
                        "2024-01-02": []}
    ...
    def test_get_stock_price_change_percentage(self) -> None:
