...
from smrti_quant_alerts.alerts import StockPriceTopPerformerAlert
...
class TestStockAlert(unittest.TestCase):
    ...
    #     with patch.object(StockPriceTopPerformerAlert, "get_sp_500_list", return_value=[stock1]), \
    #         patch.object(StockPriceTopPerformerAlert, "get_nasdaq_list", return_value=[stock2, stock3]), \
    #         patch.object(StockPriceTopPerformerAlert, "get_stock_price_change_percentage", return_value={
    ...
    #     self.alert.CONFIG.SETTINGS = {"Stock_Alert": {"database_name": "stork_alert"}}
    #     stock1, stock2 = StockSymbol("TEST1", "test1", "t", "t", "t", "t", "2000", True), \
    #         StockSymbol("TEST2", "test2", "t", "t", "t", "t", "2000", False, True)
    #     with patch.object(StockPriceTopPerformerAlert, "get_top_n_non_etf_stocks", return_value={
    #             "1D": [(stock1, 24.098), (stock2, -23.234)]}), \
    #             patch.object(StockPriceTopPerformerAlert, "get_stock_info", return_value=[stock1, stock2]):
